...
public class ConfigurationManager
	...
	private static ConfigurationManager 	configTemp	= null;
	private static ConfigurationManager 	config 		= null;
	private static final AEMonitor			classMon	= new AEMonitor("ConfigMan:class");
	...
	public static ConfigurationManager getInstance() {
		try {
			...
			if (config == null) {
				...
				if (configTemp == null) {
					configTemp = new ConfigurationManager();
					configTemp.load();
					configTemp.initialise();
					config = configTemp;
				} else {
					if (configTemp.propertiesMap == null) {
						configTemp.load();
					}
					return (configTemp);
				}
	...
	public void save(String filename) {
		 ...
		 */
		TreeMap<String,Object> propertiesClone = propertiesMap.toTreeMap();
		// Remove any transient parameters.
		if (!this.transientProperties.isEmpty()) {
			propertiesClone.keySet().removeAll(this.transientProperties);
		}
	...
	public boolean getBooleanParameter(String parameter) {
		...
		try {
			...
			result = getIntParameter(parameter, ConfigurationDefaults.defBoolean);
		}
		return result == 0 ? false : true;
	}
	...
	public int getIntParameter(String parameter) {
		...
		try {
			...
			result = getIntParameter(parameter, ConfigurationDefaults.defInt);
		}
		return result;
	}
	...
	public long getLongParameter(String parameter) {
		...
		try {
			...
			result = getLongParameter(parameter, ConfigurationDefaults.defLong);
		}
		return result;
	}
	...
	public byte[] getByteParameter(String parameter) {
		...
		try {
			...
			result = getByteParameter(parameter, ConfigurationDefaults.defBytes);
		}
		return result;
	}
	...
	public String getStringParameter(String parameter) {
		...
		try {
			...
			result = getStringParameter(parameter, ConfigurationDefaults.defString);
		}
		return result;
	}
	...
	public float getFloatParameter(String parameter) {
		return (getFloatParameter( parameter, ConfigurationDefaults.defFloat));
	}
	...
	public float getFloatParameter(String parameter, float def_val) {
		...
		try {
			...
			if (!s.equals(ConfigurationDefaults.defString))
	...
	public void registerTransientParameter(String param) {
		this.transientProperties.add(param);
	}
	...
	public boolean doesParameterNonDefaultExist(
		String parameter ) {
	...
	public void addResetToDefaultsListener(
	...
	private void updateExportableParameter(
	String		key ) {
	...
	public void addParameterListener(
		String 				parameter,
