	...
	implements IpFilter
{
	  ...
	  String ipAddress)
  {
	...
	public void setInRangeAddressesAreAllowed(
		boolean	b) {
	...
	public void removeExcludedHash(
		byte[]		hash) {
		synchronized(this) {
	...
	public void addExternalHandler(
		IpFilterExternalHandler h) {
		external_handlers.add(h);
	}

	public void removeExternalHandler(
		IpFilterExternalHandler h) {
