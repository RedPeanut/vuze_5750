...
<XTF> 	short m_port;
	...
	*/
	...
	public PRUDPPacketRequestAnnounce2(long conId) {
		super(PRUDPPacketTracker.ACT_REQUEST_ANNOUNCE, conId);
	}

	protected PRUDPPacketRequestAnnounce2(
		DataInputStream		is,
		long				conId,
		int					transId)
		throws IOException
	{
		super(PRUDPPacketTracker.ACT_REQUEST_ANNOUNCE, conId, transId);
	...
	public String getString() {
		return (super.getString()).concat("[").concat(
					...
					"peer="+ByteFormatter.nicePrint(peerId, true)+
					"dl="+downloaded+
					"ev="+event+
					"ip="+ipAddress+
					"key="+key+
