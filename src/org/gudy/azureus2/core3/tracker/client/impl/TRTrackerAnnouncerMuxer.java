	...
	extends TRTrackerAnnouncerImpl
{
	...
	private TRTrackerAnnouncerResponse			lastResponseInformed;
		...
		throws TRTrackerAnnouncerException
	{
		super(_torrent);
		try {
			lastResponseInformed = new TRTrackerAnnouncerResponseImpl(
					null, 
	...
	public void setAnnounceDataProvider(
	...
	public void setRefreshDelayOverrides(
		int		percentage) {
		for (TRTrackerAnnouncer announcer: announcers) {
