				...
				TRTrackerServerRequestListener, TRTrackerServerAuthenticationListener
{
	...
	protected void hostTorrentStateChange(
		TRHostTorrent host_torrent) {
		try {
			this_mon.enter();
	...
	protected void addExternalTorrent(
		byte[]		hash,
		int			state,
		long		date_added) {
		try {
	...
	public boolean handleExternalRequest(
	...
	protected void addTrackerAnnounce(
		TOTorrent	torrent) {
