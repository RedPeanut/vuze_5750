	...
	implements TRHostTorrent
{
	...
	protected TRHostTorrentHostImpl(
		TRHostImpl		_host,
	...
	protected void setTorrentInternal(
		TOTorrent		_torrent) {
		torrent = _torrent;
	}
	...
	protected void setStartOfDayValues(
		long		_date_added,
		long		completed,
		long		announces,
		long		scrapes,
	...
	public void addRemovalListener(
	...
	public void removeRemovalListener(
		TRHostTorrentWillBeRemovedListener	l) {
		try {
			this_mon.enter();
