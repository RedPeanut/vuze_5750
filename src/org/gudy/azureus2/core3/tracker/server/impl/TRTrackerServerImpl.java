	...
	implements 	TRTrackerServer
{
	...
	public void setEnableKeepAlive(
		boolean	enable) {
	...
	public boolean performExternalAuthorisation(
	...
	public long getAnnounceRetryInterval(
	...
	public long getScrapeRetryInterval(
		TRTrackerServerTorrentImpl	torrent) {
		long	clients = current_total_clients;
