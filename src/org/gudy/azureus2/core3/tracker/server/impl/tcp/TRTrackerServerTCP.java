	...
	extends 	TRTrackerServerImpl
{
	...
	public void setRestrictNonBlocking(
		boolean restrict) {
	...
	protected boolean checkDOSRemove(
		Map.Entry		eldest) {
	...
	protected boolean handleExternalRequest(
