...
TorrentUtils
{
	...
	public static TOTorrent readFromFile(
		File		file,
		boolean		create_delegate,
		boolean		force_initial_discard )
	...
	public static void setMemoryOnly(
		TOTorrent			torrent,
		boolean				mem_only) {
		if (mem_only) {
	...
	public static String exceptionToText(
	...
	public static String announceGroupsToText(
		TOTorrent	torrent) {
		URL	announce_url = torrent.getAnnounceURL();
	...
	public static void listToAnnounceGroups(
		List<List<String>>		groups,
		TOTorrent				torrent) {
	...
	public static void announceGroupsInsertFirst(
		TOTorrent	torrent,
		String		first_url) {
		try {
	...
	public static void announceGroupsInsertLast(
		TOTorrent	torrent,
		URL[]		first_urls) {
		TOTorrentAnnounceURLGroup group = torrent.getAnnounceURLGroup();
	...
	public static void setResumeDataCompletelyValid(
		DownloadManagerState	download_manager_state) {
		DiskManagerFactory.setResumeDataCompletelyValid(download_manager_state);
	}

	public static String getLocalisedName(
		TOTorrent		torrent) {
		if (torrent == null) {
			return "";
		}
	...
	public static void setTLSTorrentHash(
		HashWrapper		hash) {
	...
	public static void setTLSDescription(
		String		desc) {
	...
	public static void setDecentralised(
		TOTorrent	torrent) {
	...
	private static String getContentMapString(
		TOTorrent	torrent,
		String 		key ) {
	...
	public static void setObtainedFrom(
		File			file,
		String			str) {
		try {
	...
	public static String getObtainedFrom(
		TOTorrent		torrent) {
		Map	m = getAzureusPrivateProperties(torrent);
	...
	public static void setNetworkCache(
		TOTorrent		torrent,
	...
	public static void setTagCache(
		TOTorrent		torrent,
		List<String>	networks) {
		Map	m = getAzureusPrivateProperties(torrent);
	...
	public static void setPeerCache(
		TOTorrent		torrent,
		Map				pc) {
		Map	m = getAzureusPrivateProperties(torrent);
	...
	public static void setPeerCacheValid(
		TOTorrent		torrent) {
		Map	m = getAzureusPrivateProperties(torrent);
	...
	public static void setPluginStringProperty(
		TOTorrent		torrent,
		String			name,
		String			value) {
		Map	m = getAzureusProperties(torrent);
	...
	public static String getPluginStringProperty(
		TOTorrent		torrent,
		String			name) {
		Map	m = getAzureusProperties(torrent);
	...
	public static void setPluginMapProperty(
		TOTorrent		torrent,
		String			name,
		Map				value) {
		Map	m = getAzureusProperties(torrent);
	...
	public static void setDHTBackupEnabled(
		TOTorrent		torrent,
		boolean			enabled) {
		Map	m = getAzureusProperties(torrent);
	...
	public static void setDHTBackupRequested(
		TOTorrent		torrent,
		boolean			requested) {
		Map	m = getAzureusProperties(torrent);
	 ...
	 */
	public static void registerMapFluff(
		String[]		fluff) {
 ...
 outer:
  ...
  public static DownloadManager getDownloadManager(HashWrapper	hash) {
	...
	public static void addCreatedTorrent(
		TOTorrent		torrent) {
	...
	public static void removeCreatedTorrent(
		TOTorrent		torrent) {
		synchronized(created_torrents) {
	...
	private static void fireAttributeListener(
		TOTorrent		torrent,
		String			attribute,
		Object			value) {
	...
	public static void addTorrentAttributeListener(
	...
	public static void addTorrentURLChangeListener(
		TorrentAnnounceURLChangeListener	listener) {
		torrent_url_changed_listeners.add(listener);
	}

	public static void removeTorrentURLChangeListener(
		TorrentAnnounceURLChangeListener	listener) {
	...
	public static void runTorrentDelete(
		Runnable 	target) {
		try {
			startTorrentDelete();
