...
public class UrlUtils
{
	...
	public static String getMagnetURI(
		byte[]		hash) {
	...
	private static String encodeNetworks(
		String[]	networks) {
		String	net_str = "";
	...
	public static String normaliseMagnetURI(
		String		base_hash) {
	...
	public static String parseTextForMagnets(
		String		text) {
	...
	public static String decodeIfNeeded(
		String s ) {
		if (s == null) {
	...
	public static String convertIPV6Host(
		String	host) {
		if (host.indexOf(':') != -1) {
	...
	public static String expandIPV6Host(
		String	host) {
		if (host.indexOf(':') != -1) {
	...
	public static void connectWithTimeout(
	...
	public static void connectWithTimeouts(
		final URLConnection		connection,
		long					connect_timeout,
		long					read_timeout )
	...
	private static String getBrowserHeadersToUse(
		String		encoded_headers) {
	...
	public static String getCanonicalString(
		URL		url) {
