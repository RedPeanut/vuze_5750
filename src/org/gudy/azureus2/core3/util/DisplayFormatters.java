...
DisplayFormatters
{
	...
	public static String getRateUnit(
		int		unit_size) {
	...
	public static String formatDataProtByteCountToKiBEtc(
		long	data,
		long	prot) {
	...
	public static String formatDataProtByteCountToKiBEtcPerSec(
		long	data,
		long	prot) {
		if (separate_prot_data_stats) {
			if (data == 0 && prot == 0) {
	...
	public static String formatByteCountToKiBEtcPerSec(
		long		n) {
	...
	public static String formatByteCountToBase10KBEtc(
			long n) {
	...
	public static String formatByteCountToBase10KBEtcPerSec(
			long		n) {
	...
	public static String formatDownloaded(
	...
	public static String formatHashFails(
	...
	public static String formatDownloadStatus(
	...
	public static String trimDigits(
		String		str,
		int			num_digits) {
	...
	private static void updateFormatOverrides(
		String	formats) {
	...
	public static String formatCustomRate(
		String		key,
		long		value) {
	...
	public static String formatCustomSize(
		String		key,
		long		value) {
		Formatter formatter = format_map.get(key);
