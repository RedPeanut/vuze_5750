...
public class BDecoder {
	...
	private static String TAG = BDecoder.class.getSimpleName();
	...
	private boolean	verifyMapOrder;
	...
	public static Map<String,Object> decode(byte[] data)
		...
		/*Log.d(TAG, "decode(byte[]) is called...");
	...
	public static Map<String,Object> decode(
		...
		throws IOException
	{
		/*Log.d(TAG, "decode(byte[], int, int) is called...");
		Throwable t = new Throwable();
		t.printStackTrace();*/
	...
	public static Map<String,Object> decode(BufferedInputStream is) throws IOException {
		...
		/*Log.d(TAG, "decode(BufferedInputStream) is called...");
		Throwable t = new Throwable();
		t.printStackTrace();*/
	...
	public Map<String, Object> decodeStream(
		BufferedInputStream data,
		boolean internKeys)
		throws IOException {
