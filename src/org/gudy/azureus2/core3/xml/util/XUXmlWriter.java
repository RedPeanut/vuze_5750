...
XUXmlWriter
{
	...
	protected void setGenericSimple(
		boolean		simple) {
	...
	protected void writeLineRaw(
		String	str) {
		writer.println(current_indent_string + str);
	}

	protected void writeLineEscaped(
		String	str) {
	...
	protected void writeGenericMapEntry(
		String	name,
		Object	value) {
		if (generic_simple) {
	...
	protected void writeLocalisableTag(
		String		tag,
		byte[]		content) {
