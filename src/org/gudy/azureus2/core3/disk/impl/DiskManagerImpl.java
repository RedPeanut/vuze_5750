...
public class DiskManagerImpl
    ...
    private static final DiskAccessController diskAccessController;
    ...
    private static final ThreadPool	startPool = new ThreadPool("DiskManager:start", 64, true);
    static {
    	startPool.setThreadPriority(Thread.MIN_PRIORITY);
    }
    ...
    private boolean             skippedFileSetChanged =true; // go over them once when starting
    ...
    private boolean allocateFile(
    	DiskManagerFileInfoImpl		fileInfo,
    	File						data_file,
    	long						existing_length,	// -1 if not exists
    	long						target_length ) throws Throwable {
        while (started) {
	...
	public boolean hasOutstandingReadRequestForPiece(int pieceNumber) {
		return (reader.hasOutstandingReadRequestForPiece(pieceNumber));
	}
	...
	public void checkFreePieceList(
	...
	public boolean hasOutstandingWriteRequestForPiece(
		int		piece_number) {
	...
	public boolean checkBlockConsistencyForRead(
		String	originator,
	...
	public boolean checkBlockConsistencyForHint(
		String	originator,
	    int 	pieceNumber,
	    int 	offset,
	    int 	length) {
