...
public class PEPeerTransportFactory {
	 ...
	 * @return transport
	 */
	public static PEPeerTransport createTransport(
		...
		int					udpPort,
		boolean				useTcp,
		boolean 			requireCryptoHandshake,
		byte				cryptoLevel,
		Map					initialUserData) {
		return new PEPeerTransportProtocol(control, peerSource, ip, tcpPort, udpPort, useTcp, requireCryptoHandshake, cryptoLevel, initialUserData);
	}
	...
	public static PEPeerTransport createTransport(
		...
		Map					initialUserData) {
		return new PEPeerTransportProtocol(control, peerSource, connection, initialUserData);
	}

	public static void registerExtensionHandler(
		String								protocolName,
		PEPeerTransportExtensionHandler		handler) {
		extension_handlers.put(protocolName, handler);
	}

	public static List createExtendedTransports(
