	...
	extends BrowserWrapper
{
	...
	public void addStatusTextListener(
		StatusTextListener		l) {
		browser.addStatusTextListener(l);
	}

	public void removeStatusTextListener(
		StatusTextListener		l) {
		browser.removeStatusTextListener(l);
	}

	public BrowserFunction addBrowserFunction(String						name,
