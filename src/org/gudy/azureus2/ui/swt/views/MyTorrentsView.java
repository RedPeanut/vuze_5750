...
{
	private static String TAG = MyTorrentsView.class.getSimpleName();
	...
	public static void registerPluginViews(
		...
		if (pluginUI != null && !registeredCoreSubViews) {
			...
			for (String id: viewsWithTabs) {
				...
				//Log.d(TAG, ">>> Logger.isEnabled() = " + Logger.isEnabled());
