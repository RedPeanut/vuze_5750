	...
	implements Plugin, TrackerWebPageGenerator
{
	...
	private String getConnectionTestURL(
		String		sid) {
		...
		try {
			...
			tracker_context.addAuthenticationListener(
				new TrackerAuthenticationAdapter() {
					...
					private boolean authenticateSupport(
						String		headers,
						URL			resource,
						String		user,
						String		pw) {
	...
	private void recordAuthRequest(
		String						client_ip,
		boolean						good) {
		PairingManager pm = PairingManagerFactory.getSingleton();
	...
	private String getArgumentFromURL(
		URL			url,
		String		argument) {
	...
	private boolean returnTextPlain(
		TrackerWebPageResponse		response,
		String						str) {
