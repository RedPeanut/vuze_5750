...
public class PlatformManagerImpl
	...
	public void setPreventComputerSleep(
		boolean		prevent_it) {
		synchronized(this) {
		...
		throws Exception
	{
		...
		update_manager.addListener(
			new UpdateManagerListener() {
				public void checkInstanceCreated(
	...
	public int getAdditionalFileTypeRegistrationDetails(
		String		name,
		String		type )
