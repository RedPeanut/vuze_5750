...
public class PluginManagerImpl extends PluginManager {
	...
	protected static AzureusCore		azureusCore;
	...
	startAzureus(
		...
		return ( azureusCore.getPluginManager());
	}
		...
		throws PluginException
	{
		...
		try {
			azureusCore.executeCloseAction(action, "plugin requested");
