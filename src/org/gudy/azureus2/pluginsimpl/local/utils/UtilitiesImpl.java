	...
	implements Utilities, FeatureManager
{
	...
	public String reverseDNSLookup(
		InetAddress		address) {
		...
		IPToHostNameResolver.addResolverRequest(
					...
					new IPToHostNameResolverListener() {
						public void IPResolutionComplete(
							String 		result,
							boolean 	succeeded) {
							if (succeeded) {
  ...
  public long getCurrentSystemTime() {
	...
	public static void addSearchManager(
		...
		implements LimitedRateGroup
	{
		...
		private PluginLimitedRateGroup(
