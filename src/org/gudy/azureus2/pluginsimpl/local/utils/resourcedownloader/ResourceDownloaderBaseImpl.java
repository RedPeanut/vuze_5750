	...
	implements ResourceDownloader
{
	...
	protected Object getPropertySupport(
		String	name) {
	...
	protected void setPropertySupport(
		String	name,
		Object	value) {
	...
	protected void setPropertyRecursive(
		String		name,
		Object		value )
	...
	protected void addReportListener(
	...
	protected void informPercentDone(
		int	percentage) {
	...
	protected void informAmountComplete(
		long	amount) {
		for (int i=0;i<listeners.size();i++) {
	...
	protected boolean informComplete(
		InputStream	is) {
		if (!result_informed) {
