	...
	implements EnablerParameter, org.gudy.azureus2.core3.config.ParameterListener
{
	...
	public void setMinimumRequiredUserMode(
		int 	_mode) {
		mode	= _mode;
	}
	...
	public void setGenerateIntermediateEvents(
		boolean		b) {
	...
	public void removeImplListener(
		ParameterImplListener	l) {
		if (impl_listeners == null) {
			return;
		}
	...
	public void addConfigParameterListener(
	...
	public void removeConfigParameterListener(
		ConfigParameterListener	l) {
		if (listeners == null) {
			return;
		}
