	...
	implements BasicPluginConfigModel
{
	...
	public BasicPluginConfigModelImpl(
		UIManagerImpl		_uiManager,
		String				_parentSection,
		String				_section) {
		
		uiManager		= _uiManager;
		parentSection	= _parentSection;
		section			= _section;
		pi				= uiManager.getPluginInterface();
		key_prefix		= pi.getPluginconfig().getPluginConfigKeyPrefix();
		configobj       = (PluginConfigImpl)pi.getPluginconfig();
		if (parentSection != null && !parentSection.equals(ConfigSection.SECTION_ROOT)) {
	...
	public org.gudy.azureus2.plugins.ui.config.BooleanParameter addBooleanParameter2(
		String 		key,
		String 		resource_name,
		boolean 	defaultValue) {
	...
	public org.gudy.azureus2.plugins.ui.config.StringParameter addStringParameter2(
		String 		key,
		String 		resource_name,
		String  	defaultValue) {
	...
	public org.gudy.azureus2.plugins.ui.config.StringListParameter addStringListParameter2(
		String 		key,
		String 		resource_name,
		String[]	values,
		String	 	defaultValue) {
