	...
	extends NetworkConnectionHelper
{
	...
	protected PeerForeignNetworkConnection(
		...
		implements IncomingMessageQueue
	{
		...
		public void notifyOfExternallyReceivedMessage(
			Message message) {
		}
		...
		public void cancelQueueListener(
			MessageQueueListener listener) {
		}
		...
		implements OutgoingMessageQueue
	{
		...
		public void removeMessagesOfType(
		...
		public void notifyOfExternallySentMessage(
			Message message) {
		}
	}
}
