	...
	implements PluginManagerDefaults
{
	...
	public void setDefaultPluginEnabled(
		String	plugin_id,
		boolean	enabled) {
		if (enabled) {
	...
	public boolean isDefaultPluginEnabled(
		String		plugin_id) {
	...
	public void setApplicationEntryPoint(
		String		ep) {
	...
	public void setSingleInstanceHandler(
	...
	public boolean setSingleInstanceHandlerAndProcess(
		int									single_instance_port,
		PluginManagerArgumentHandler		handler,
		String[]							args) {
		PluginSingleInstanceHandler.initialise(single_instance_port, handler);
