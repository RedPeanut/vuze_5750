	...
	implements UTPTranslated
{
	...
	*/
	...
	public static PacketFormatDeserialised deserialise(
		byte[]		data,
		int			len,
		boolean		test_only) {
...
//				assert(-int64(dist_down) < INT_MAX / 4);
	...
	*/
	...
	public boolean UTP_IsIncomingUTP(
