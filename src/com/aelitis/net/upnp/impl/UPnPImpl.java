	...
	implements 	UPnP, SSDPIGDListener
{
	...
	public void injectDiscoveryCache(
		Map 		cache) {
		try {
	...
	public void addRootDeviceListener(
	...
	public void removeRootDeviceListener(
		UPnPListener	l) {
		try {
			this_mon.enter();
