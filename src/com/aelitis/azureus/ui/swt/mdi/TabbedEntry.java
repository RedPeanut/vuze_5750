...
public class TabbedEntry
	...
	private static String TAG = TabbedEntry.class.getSimpleName();
	...
	public SWTSkinObjectContainer buildStandAlone(SWTSkinObjectContainer soParent) {
		...
		if (skinRef != null) {
			...
			if (eventListener instanceof UISWTViewCoreEventListenerEx && ((UISWTViewCoreEventListenerEx)eventListener).isCloneable()) {
				...
				try {
					view.setEventListener(((UISWTViewCoreEventListenerEx)eventListener).getClone(),false);
				} catch (Throwable e) {
