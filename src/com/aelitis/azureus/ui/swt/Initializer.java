...
public class Initializer implements IUIIntializer {
	...
	private AESemaphore initTask = new AESemaphore("delayed init");
	...
	public void run() {
		DelayedTask delayedTask = UtilitiesImpl.addDelayedTask("SWT Initialisation", new Runnable() {
			public void run() {
				initTask.reserve();
			}
		});
		delayedTask.queueFirst();
