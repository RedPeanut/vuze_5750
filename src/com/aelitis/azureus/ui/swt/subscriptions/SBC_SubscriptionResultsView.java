	...
	implements UIUpdatable, UIPluginViewToolBarListener, TableViewFilterCheck<SBC_SubscriptionResult>, SubscriptionListener
{
	...
	public Object skinObjectInitialShow(
	...
	public Object dataSourceChanged(
		SWTSkinObject skinObject, Object params) {
		synchronized(this) {
	...
	public void subscriptionDownloaded(
		Subscription		subs,
		boolean				auto) {
	}
	...
	public Object skinObjectHidden(
		SWTSkinObject 	skinObject,
		Object 			params ) {
		hideView();
	...
	public Object skinObjectDestroyed(
		SWTSkinObject 	skinObject,
		Object 			params ) {
		synchronized(this) {
