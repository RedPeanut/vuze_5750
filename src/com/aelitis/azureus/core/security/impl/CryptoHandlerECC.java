	...
	implements CryptoHandler
{
	...
	public void setUnlockTimeoutSeconds(
		int		secs) {
	...
	public void setDefaultPasswordHandlerType(
		int		new_type )
		...
		extends JCEIESCipher.ECIES
	{
		...
		public void internalEngineInit(
			int                     opmode,
			Key                     key,
