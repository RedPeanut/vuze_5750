...
public abstract class HTTPNetworkConnection {
	...
	protected static boolean checkConnections(
	...
	protected HTTPNetworkConnection(
	...
	protected abstract void decodeHeader(
	...
	protected void flushRequestsSupport(
		final flushListener		l) {
