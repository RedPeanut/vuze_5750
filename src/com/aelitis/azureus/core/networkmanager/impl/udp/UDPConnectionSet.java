...
UDPConnectionSet
{
	...
	protected boolean remoteLastInSequence(
		int			alt_sequence) {
	...
	protected void receiveDataCommand(
		int				sequence,
		ByteBuffer		buffer,
		int				header_length )
	...
	protected void receiveAckCommand(
		ByteBuffer		buffer )
	...
	protected void receiveStatsRequest(
		ByteBuffer		buffer )
	...
	protected void receiveStatsReply(
		ByteBuffer		buffer )
	...
	protected void receiveCloseCommand(
		ByteBuffer		buffer )
