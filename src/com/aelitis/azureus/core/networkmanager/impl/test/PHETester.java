...
public class PHETester {
	...
	private final VirtualChannelSelector connectSelector = new VirtualChannelSelector("PHETester", VirtualChannelSelector.OP_CONNECT, true);
	...
	public PHETester() {
		...
		VirtualServerChannelSelector
			acceptServer = VirtualServerChannelSelectorFactory.createNonBlocking(
