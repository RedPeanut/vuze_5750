	...
	implements FMFile
{
	...
	protected void setAccessModeSupport(
		int		mode) {
		access_mode	= mode;
	}
	...
	protected void setLengthSupport(
		long		length )
	...
	protected boolean isPieceCompleteProcessingNeeded(
		int					piece_number )
	...
	protected void setPieceCompleteSupport(
		int					piece_number,
