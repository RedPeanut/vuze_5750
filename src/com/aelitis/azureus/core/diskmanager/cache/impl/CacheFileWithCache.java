	...
	implements CacheFile
{
  ...
  protected static final Comparator comparator = new
	...
	protected void flushCacheSupport(
		long				file_position,
		long				length,					// -1 -> do all from position onwards
		boolean				release_entries,
		long				minimum_to_release,		// -1 -> all
	...
	protected void multiBlockFlush(
	...
	protected void flushCachePublic(
		boolean				release_entries,
		long				minumum_to_release )
	...
	protected void flushOldDirtyData(
	...
	protected void getBytesInCache(
		boolean[] toModify,
	...
	protected void setPendingException(
	...
	public void writeAndHandoverBuffer(
		DirectByteBuffer	buffer,
		long				position )
	...
	public void writeAndHandoverBuffers(
		DirectByteBuffer[]	buffers,
		long				position )
