	...
	implements CacheFileManager, AEDiagnosticsEvidenceGenerator
{
  private static final LogIDs LOGID = LogIDs.CACHE;
	...
	protected void releaseCacheSpace(
		CacheEntry		entry )
	...
	protected void cacheBytesWritten(
		long		num) {
		try {
			this_mon.enter();
	...
	protected void fileBytesWritten(
		long	num) {
		try {
			this_mon.enter();
