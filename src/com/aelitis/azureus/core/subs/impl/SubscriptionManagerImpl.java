	...
	implements SubscriptionManager, AEDiagnosticsEvidenceGenerator
{
	...
	public SearchInstance searchSubscriptions(
		Map<String,Object>		search_parameters,
	...
	public void setSubsDownloadEnabled(
		boolean		enabled) {
	...
	public void setActivateSubscriptionOnChange(
		boolean		b) {
	...
	public Subscription createSingletonRSS(String		name,
		URL			url,
	...
	lookupSingletonRSS(String		name,
		URL			url,
		boolean		is_public,
		int			check_interval_mins )
	...
	createSingletonRSSSupport(String		name,
		URL			url,
		boolean		is_public,
		int			check_interval_mins,
		int			add_type,
	...
	public Subscription importSubscription(
		int			type,
		Map			map,
		boolean		warn_user )
	...
	protected SubscriptionImpl
	getSubscriptionFromName(String		name) {
		synchronized(this) {
	...
	public SubscriptionAssociationLookup lookupAssociations(
		byte[]						hash,
		String[]					networks,
	...
	public void setMaxNonDeletedResults(
		int		max) {
	...
	public void setAutoStartDownloads(
		boolean		auto_start) {
	...
	public void setAutoDownloadMarkReadAfterDays(
		int		days) {
	...
	private DHTPluginInterface
	selectDHTPlugin(String[]		networks) {
