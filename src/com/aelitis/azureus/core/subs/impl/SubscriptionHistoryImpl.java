	...
	implements SubscriptionHistory
{
	...
	public void setNotificationPostEnabled(
		boolean	enabled) {
	...
	public void setCheckFrequencyMins(
		int		mins) {
	...
	protected void
	setFatalError(String		_error) {
		last_error		= _error;
		consec_fails	= 1024;
	}

	protected void
	setLastError(String		_last_error,
	...
	public void setDownloadWithReferer(
		boolean		b) {
		if (b != dl_with_ref) {
