	...
	implements DHTTransport
{
	...
	public static void setFailPercentage(
		int	p) {
		FAIL_PERCENTAGE	= p;
	}
	...
	public DHTTransportLoopbackImpl(
		int							_id_byte_length) {
	...
	public void sendKeyBlockSupport(
		DHTTransportContact			contact,
		DHTTransportReplyHandler	handler,
		byte[]						request,
		byte[]						sig) {
	...
	public void sendFindValueSupport(
		DHTTransportContact			contact,
		DHTTransportReplyHandler	handler,
		byte[]						key,
		int							max,
