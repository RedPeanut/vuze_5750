...
DHTNetworkPositionManager
{
	...
	public static DHTNetworkPositionProviderInstance registerProvider(
		...
		return (
			new DHTNetworkPositionProviderInstance() {
	...
	public static float estimateRTT(
	...
	public static DHTNetworkPosition deserialisePosition(
	...
	public static DHTNetworkPosition deserialise(
		InetAddress				originator,
		byte					position_type,
		DataInputStream			is )
		throws IOException
	...
	public static void removePositionListener(
