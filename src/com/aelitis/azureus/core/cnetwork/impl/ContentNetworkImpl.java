	...
	implements ContentNetwork
{
	...
	protected static ContentNetworkImpl importFromBEncodedMapStatic(
	...
	protected boolean
	hasPersistentProperty(String		name) {
		synchronized(this) {
	...
	public void addPersistentPropertyChangeListener(
		ContentNetworkPropertyChangeListener	listener) {
		persistent_listeners.add(listener);
	}

	public void removePersistentPropertyChangeListener(
		ContentNetworkPropertyChangeListener	listener) {
