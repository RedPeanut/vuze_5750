...
EnhancedDownloadManager
{
	...
	protected EnhancedDownloadManager(
	...
	public void setExplicitProgressive(
	...
	public void prepareForProgressiveMode(
		boolean		active) {
		enhancer.prepareForProgressiveMode(download_manager, active);
	}

	public boolean setProgressiveMode(
		boolean		active) {
		return (setProgressiveMode( active, false));
	}

	protected boolean setProgressiveMode(
		boolean		active,
	...
	protected boolean updateProgressiveStats(
		int		tick_count) {
		if (!progressive_active) {
	...
	public long getContiguousAvailableBytes(
		int						file_index,
		...
		extends progressiveStats
	{
		...
		protected void updateCurrentProvider(
		...
		protected long getCurrentProviderPosition(
			boolean		absolute) {
