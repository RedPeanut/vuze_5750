	...
	implements AEProxy, VirtualChannelSelector.VirtualSelectorListener
{
	...
	public void setAllowExternalConnections(
		boolean	permit) {
	...
	protected void requestWriteSelect(
		AEProxyConnectionImpl	processor,
		SocketChannel 			sc) {
	...
	protected void cancelWriteSelect(
		SocketChannel 			sc) {
		write_select_regs.remove(sc);
		write_selector.cancel(sc);
	}

	protected void requestReadSelect(
		AEProxyConnectionImpl	processor,
		SocketChannel 		sc) {
		read_selector.register(sc, this, processor);
	}

	protected void cancelReadSelect(
		SocketChannel 		sc) {
		read_selector.cancel(sc);
	}

	protected void requestConnectSelect(
		AEProxyConnectionImpl	processor,
		SocketChannel 			sc) {
		connect_selector.register(sc, this, processor);
	}

	protected void cancelConnectSelect(
		SocketChannel 		sc) {
