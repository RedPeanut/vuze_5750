...
PlatformMetaSearchMessenger
{
	...
	getTemplate(String		extension_key,
		long		template_id )
	...
	public static templateInfo[]
	listTopPopularTemplates(String		extension_key,
		String		fud )
	...
	public static templateInfo[]
	listFeaturedTemplates(String		extension_key,
		String		fud )
	...
	public static void
	setTemplatetSelected(String		extension_key,
		long		template_id,
		String		user_id,
		boolean		is_selected )
