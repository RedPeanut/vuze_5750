	...
	implements DiskManagerHelper
{
	...
	public void enqueueWriteRequest(
	...
	public boolean hasOutstandingReadRequestForPiece(
		int		piece_number) {
	...
	public boolean checkBlockConsistencyForWrite(
		String				originator,
		int 				pieceNumber,
		int 				offset,
		DirectByteBuffer 	data) {
