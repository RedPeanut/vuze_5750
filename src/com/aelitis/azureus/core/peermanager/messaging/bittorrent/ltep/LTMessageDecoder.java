...
public class LTMessageDecoder extends BTMessageDecoder {
	...
	public static void addDefaultExtensionHandler(
		long		id,
		byte[]		message_id) {
		default_entension_handlers.put((byte)id, message_id);
	}
	public static void removeDefaultExtensionHandler(
		long		id) {
	...
	public void addExtensionHandler(
		byte		id,
		byte[]		message_id) {
		extension_handlers.put(id, message_id);
	}
	public void removeExtensionHandler(
		byte		id) {
