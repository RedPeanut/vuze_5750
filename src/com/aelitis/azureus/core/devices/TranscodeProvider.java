...
TranscodeProvider
{
	...
	public TranscodeProfile[]
	getProfiles(String	classification_prefix);

	public TranscodeProfile getProfile(String		UID);

	public TranscodeProfile addProfile(
		File		file )

		throws TranscodeException;

	public TranscodeProviderAnalysis analyse(
	...
	public TranscodeProviderJob transcode(
		TranscodeProviderAdapter	adapter,
