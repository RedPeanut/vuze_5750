	...
	implements DeviceManager, DeviceOfflineDownloaderManager, PowerManagementListener, AEDiagnosticsEvidenceGenerator
{
	...
	public void setAutoHideOldDevicesDays(
		int		days) {
	...
	public void setOfflineDownloadingEnabled(
		boolean		enabled) {
	...
	public void setOfflineDownloadingIsAuto(
		boolean		auto) {
	...
	public void setOfflineDownloadingIncludePrivate(
		boolean		include) {
	...
	public void addManualDownloads(
		Download[]		downloads) {
	...
	public void removeManualDownloads(
		Download[]		downloads) {
		for (Download d: downloads) {
	...
	public boolean requestPowerStateChange(
		int		new_state,
		Object	data) {
		if (getDisableSleep()) {
	...
	public void informPowerStateChange(
		int		new_state,
		Object	data) {
  ...
  public Device findDevice(UPnPDevice upnpDevice) {
		...
		implements DeviceManufacturer
	{
		...
		protected
		DeviceManufacturerImpl(String		_name) {
			name	= _name;
		}
