	...
	implements Device
{
	...
	modifyDeviceDisplayName(String		name) {
	...
	protected String
	allocateUniqueFileName(String		str) {
	...
	public TranscodeFileImpl lookupFile(
		TranscodeProfile		profile,
		DiskManagerFileInfo		file) {
		try {
			synchronized(this) {
	...
	getTranscodeProfiles(String		classification) {
	...
	public void setDefaultTranscodeProfile(
		TranscodeProfile		profile) {
		if (profile == null) {
	...
	public void setTranscodeRequirement(
		int		req) {
		setPersistentIntProperty(PP_REND_TRANS_REQ, req);
	}

	public boolean isAudioCompatible(
		TranscodeFile		file) {
		return (false);
	}
	...
	public void setAlwaysCacheFiles(
	...
	public void setRSSPublishEnabled(
		boolean		enabled) {
	...
	public void setAutoShareToTagID(
		long		id) {
	...
	getPersistentMapProperty(String					prop,
		Map<String,T>			def) {
		synchronized(persistent_properties) {
	...
	public <T>void
	setPersistentMapProperty(String					prop,
		Map<String,T>			value) {
		boolean	dirty = false;
	...
	public String[]
	getPersistentStringListProperty(String		prop) {
		synchronized(persistent_properties) {
	...
	public void setTransientProperty(
		Object		key,
		Object		value) {
	...
	public Object getTransientProperty(
		Object		key) {
		synchronized(transient_properties) {
		...
		implements browseLocation
	{
		...
		protected
		browseLocationImpl(String		_name,
			URL			_url) {
			name		= _name;
			url			= _url;
		}
